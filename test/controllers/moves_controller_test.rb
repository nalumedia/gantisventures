...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { account_id: @move.account_id, amount: @move.amount, name: @move.name, notes: @move.notes } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { account_id: @move.account_id, amount: @move.amount, name: @move.name, notes: @move.notes } }
