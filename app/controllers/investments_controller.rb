class InvestmentsController < ApplicationController
  ...
  private
    ...
    def investment_params
      params.require(:investment).permit(:investment_amount, :company_id, :fees, :fee_notes, :terms, :pre_money, :post_money, :target_exit, :target_exit_notes, :ownership, :notes, :source_id, :round, :security_type)
    end
end
